...
const vi = {
  ...
  homeScreen: {
    ...
    // Budget Feature
    noBudgetSet: 'Chưa đặt ngân sách',
    setBudgetPrompt: 'Đặt ngân sách hàng tháng để theo dõi chi tiêu',
    setBudgetButton: 'Đặt Ngân Sách',
    budgetModalTitle: 'Đặt Ngân Sách Tháng',
    budgetModalDescription: 'Nhập ngân sách chi tiêu của bạn cho tháng này',
    ...
    budgetSavedMessage: 'Ngân sách hàng tháng đã được cập nhật',
    budgetSaveFailed: 'Lưu Thất Bại',
    budgetSaveFailedMessage: 'Không thể lưu ngân sách. Vui lòng thử lại.',
    editBudget: 'Sửa Ngân Sách',
    editBudgetWarningTitle: 'Sửa ngân sách?',
    editBudgetWarningMessage:
      'Việc thay đổi ngân sách thường xuyên có thể làm giảm ý nghĩa thống kê. Bạn có chắc muốn sửa?',
    editBudgetProceed: 'Tiếp tục',
  },
  dashboardScreen: {
    title: 'Tổng Quan',
